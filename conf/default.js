...
module.exports = {
	...
	// API key
	apikey: 'dEk+YkDUeQ6IgE/6IutmYVAR0G7T8PIY',
	...
	session: {
		...
		encryptionKey: 'O5Ex3WKWgYemCzPULdMHv856DQtBOCFvw5CU6Ih4HtQ=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: 'yExquCWzVaYh7MTikPYOavyzzkhUCUmnxzfZs//S8QqVI0om6uUAWnAJIUasFVkY5oGCKu2iEt6mxNH5vu2dvA==',
		secret: 'OcOFemaCIULcKn92RMGujYtrq3fEY+Zy', // should be a large unguessable string
	...
	cookieSecret: 'HO8DeQ00YH5LaQgVnk9+OSRSy/QNI7jg',
